...
function register(customer) {
  const requestOptions = {
    method: "POST",
    headers: { ...getHeader(), "Access-Control-Allow-Origin": "*" },
...
function getAll() {
  ...
  return fetch(`${config.apiUrl}/customers`, requestOptions).then(
    handleResponse
  );
}
...
function getById(id) {
  ...
  return fetch(`${config.apiUrl}/customers/${id}`, requestOptions).then(
    handleResponse
  );
}
...
function getCart() {
  ...
  return fetch(
    `${config.apiUrl}/Resource/customerOrders/cart`,
    requestOptions
...
function pay(orderId) {
  ...
  return fetch(
    `${config.apiUrl}/Resource/customerOrders/${orderId}`,
    requestOptions
  );
}
